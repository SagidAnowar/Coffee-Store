    ...
    return (
        <section>
            ...
            <section className="account-section">
                ...
                {orderHistory === undefined ? null : orderHistory.data.orders.reverse().map((order) => (order.orders.info.map((element) => {
                    return (
                        <div className="element-name-div" style={{display:"flex", justifyContent:"space-between"}}>
                            <div style={{display:"flex"}}>
                                ...
                                <div>
                                    ...
                                    <h4 className="element-info">Category: {element.category}</h4>
                                </div>
                            </div>
